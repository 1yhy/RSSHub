...
// Deprecated: DO NOT ADD ANY NEW ROUTES HERE
router.get('/tispy/home', lazyloadRouteHandler('./routes/tispy/home'));
router.get('/tispy/pricing', lazyloadRouteHandler('./routes/tispy/pricing'));

router.get('/mspy/home', lazyloadRouteHandler('./routes/mspy/home'));
router.get('/mspy/pricing', lazyloadRouteHandler('./routes/mspy/pricing'));
